// this code from lilToon
// https://github.com/lilxyzw/lilToon/blob/107ee2db75e0340d2ff7dbb5bee94076cb6576fe/Assets/lilToon/Editor/lilInspector/lilMaterialProperties.cs
...
namespace lilToonNDMFUtility
{
    public partial class lilToonInspector
    {
        ...
        internal lilMaterialProperty[] AllProperties()
        {
        ...
        internal void SetProperties(MaterialProperty[] propsSource)
        {
        ...
        internal Dictionary<PropertyBlock, List<lilMaterialProperty>> GetBlock2Properties()
        {
